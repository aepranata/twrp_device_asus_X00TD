...
BOARD_SUPER_PARTITION_GROUPS := atiga_dynpart
BOARD_ATIGA_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304)
BOARD_ATIGA_DYNPART_PARTITION_LIST := system system_ext odm product vendor
